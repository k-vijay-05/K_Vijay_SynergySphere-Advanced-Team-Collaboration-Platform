...
export default function Footer() {
  ...
  const socialLinks = [
    { name: 'Twitter', href: 'https://twitter.com/synergysphere', icon: 'twitter' },
    { name: 'LinkedIn', href: 'https://linkedin.com/company/synergysphere', icon: 'linkedin' },
    { name: 'GitHub', href: 'https://github.com/synergysphere', icon: 'github' },
    { name: 'Discord', href: 'https://discord.gg/synergysphere', icon: 'discord' },
  ];
