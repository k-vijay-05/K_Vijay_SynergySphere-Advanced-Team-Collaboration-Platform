        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="block w-64 pl-10 pr-3 py-2 border border-gray-300 rounded-lg leading-5 bg-white placeholder-gray-600 text-gray-900 focus:outline-none focus:placeholder-gray-500 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            />
          </div>
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <div className="flex items-center space-x-2">
                                <input
                                  ...
                                  onChange={() => onMarkAsRead(notification.id)}
